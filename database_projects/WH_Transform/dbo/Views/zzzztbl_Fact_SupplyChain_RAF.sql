...
------RAF data with serial number and last used workcenter
----CREATE OR ALTER        VIEW [dbo].[tbl_Fact_SupplyChain_RAF_with_Serial] 
CREATE                  VIEW [dbo].[zzzztbl_Fact_SupplyChain_RAF] 
AS 
...
from details_only_adjustments
where NOT(prodid in ('PBO0000228'))
